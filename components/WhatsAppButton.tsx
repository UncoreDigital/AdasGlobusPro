...
/**
 * Floating WhatsApp action, carried over from the live site.
 *
 * Held back until the visitor has scrolled past the first screen: on landing,
 * the hero already offers two CTAs and a third floating one competes with them
 * rather than adding a route.
 */
    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="group fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lift transition-transform hover:scale-105"
        >
          {/* Pulse ring — decorative, so it is hidden from the tree. */}
          <span
